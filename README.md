...
| -------- | ----------------------------------- | ------------------------------------------------------------------------------------------------------ |
| `pr-url` | The URL of the created pull request | **Example**: `${{ steps.<id>.outputs.pr-url }} # https://github.com/microsoft/winget-pkgs/pull/332710` |
...
Thanks goes to these wonderful people ([emoji key](https://allcontributors.org/reference/emoji-key)):
